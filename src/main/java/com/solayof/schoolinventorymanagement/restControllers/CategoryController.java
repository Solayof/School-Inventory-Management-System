...
public class CategoryController {
    ...
    public ResponseEntity<EntityModel<CategoryDto>> updateCategory(@PathVariable UUID id, @Valid @RequestBody CategoryDto entity) {
        ...
        return new ResponseEntity<EntityModel<CategoryDto>>(
            assembler.toModel(categoryService.saveCategory(category)),
            HttpStatus.ACCEPTED
        );
    }
